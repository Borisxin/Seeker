...
public class Show_Recieve_Card extends Activity {
    ...
    public static long recieve_diff;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_recieve_card);
        processViews();
        processControllers();
    }
    private void processViews(){
        Diff=(TextView) findViewById(R.id.recieve_card_diff);
        Time=(TextView) findViewById(R.id.recieve_card_time);
        Sender=(TextView) findViewById(R.id.recieve_card_sender);
        Title =(TextView) findViewById(R.id.recieve_card_title);
        Text=(TextView) findViewById(R.id.recieve_card_content);
        Photo=(ImageView) findViewById(R.id.recieve_card_pic);
        navigation=(Button) findViewById(R.id.recieve_card_navigation);
        close=(Button) findViewById(R.id.recieve_card_back);
    }
    private void processControllers(){
        CardShowCabinet.imageLoader.displayImage(url,Photo);
        Diff.setText("倒數"+recieve_diff+"天");
        Time.setText(time);
        Sender.setText("傳送者: "+sender);
        Title.setText(title);
        Text.setText(text);
